...
## [Unreleased]
## [2.1.1](https://github.com/Moraxyc/whois42d-ng/compare/v2.1.0...v2.1.1) - 2026-09-14


### 🐛 Bug Fixes


- RDAP bootstrap interoperability
...
- Disable cargo semver checks

- Use default renovate config


## [2.1.0](https://github.com/Moraxyc/whois42d-ng/compare/v2.0.2...v2.1.0) - 2026-07-04


### 🚀 Features


- Add IANA RDAP bootstrap file endpoints

- Add healthz endpoint for RDAP server
